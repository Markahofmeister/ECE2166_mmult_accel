...
set sdx_kernel_name "mm"
set sdx_kernel_type "hls"
set sdx_kernel_files {/ihome/ageorge/mah473/Desktop/Vitis_Accel_Examples/lab5_test_v4/src/mm.cpp}
set enable_xo_gen 1
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/ihome/ageorge/mah473/Desktop/Vitis_Accel_Examples/lab5_test_v4/_x.hw.xilinx_u200_xdma_201830_2/mm/mm/mm/solution"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {mm_mm_mul_32ns_43ns_75_4_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 A_p_V_1 W 0x0 "Data signal of A_p_V" {{0 32 A_p_V W 0 "Bit 31 to 0 Data signal of A_p_V"}}} {0x14 A_p_V_2 W 0x0 "Data signal of A_p_V" {{0 32 A_p_V W 0 "Bit 63 to 32 Data signal of A_p_V"}}} {0x1c B_p_V_1 W 0x0 "Data signal of B_p_V" {{0 32 B_p_V W 0 "Bit 31 to 0 Data signal of B_p_V"}}} {0x20 B_p_V_2 W 0x0 "Data signal of B_p_V" {{0 32 B_p_V W 0 "Bit 63 to 32 Data signal of B_p_V"}}} {0x28 AB_p_V_1 W 0x0 "Data signal of AB_p_V" {{0 32 AB_p_V W 0 "Bit 31 to 0 Data signal of AB_p_V"}}} {0x2c AB_p_V_2 W 0x0 "Data signal of AB_p_V" {{0 32 AB_p_V W 0 "Bit 63 to 32 Data signal of AB_p_V"}}} {0x34 N W 0x0 "Data signal of N" {{0 32 N W 0 "Bit 31 to 0 Data signal of N"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
